...
export const StaggeredMenu = ({
  ...
  const spinTweenRef = useRef<ReturnType<typeof gsap.to> | null>(null)
  const textCycleAnimRef = useRef<ReturnType<typeof gsap.to> | null>(null)
  const colorTweenRef = useRef<ReturnType<typeof gsap.to> | null>(null)
  const toggleBtnRef = useRef<HTMLButtonElement>(null)
  const busyRef = useRef(false)
  const itemEntranceTweenRef = useRef<ReturnType<typeof gsap.to> | null>(null)
